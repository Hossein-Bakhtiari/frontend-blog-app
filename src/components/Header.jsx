...
const NavItemsInfo = [
  ...
  { name: "Pages", type: "dropdown", items: ["Abot us", "Contact us"] },
    ...
    <section className="sticky top-0 left-0 right-0 z-50">
      <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        ...
        >
          ...
          <button className=" mt-5 lg:mt-0 border-2 border-blue-500 rounded-full text-blue-500 font-semibold px-6 py-2 hover:bg-blue-500 hover:text-white transition-all duration-100 ">
            Sign in
          </button>
        </div>
      </header>
